...
const (
	...
	AuthService_BlacklistToken_FullMethodName = "/auth.v1.AuthService/BlacklistToken"
)
...
func (c *authServiceClient) BlacklistToken(ctx context.Context, in *BlacklistTokenRequest, opts ...grpc.CallOption) (*BlacklistTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServiceServer) BlacklistToken(context.Context, *BlacklistTokenRequest) (*BlacklistTokenResponse, error) {
